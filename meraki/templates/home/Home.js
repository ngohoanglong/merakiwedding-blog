...
const Block1 = () => {
  ...
  return <div className='w-full flex flex-col items-center max-w-5xl mx-auto'>
    ...
    <div className="w-full lg:flex items-center space-y-6 lg:space-y-0 lg:space-x-12">
      <div className="leading-loose flex-1 text-justify">{get('Block1.text1')}</div>
      ...
      <div className="text-center flex-1 space-y-6 flex flex-col items-center">
        ...
        <div className="font-semibold text-sm">{get('Block1.text3')}</div>
      </div>
    </div>
    <div className="h-20" />
    <div className='lg:flex w-full bg-element-2'>
      <div className="lg:w-2/5 relative">
        ...
        <Image src={get('Block2.image.src')}></Image>
      </div>
