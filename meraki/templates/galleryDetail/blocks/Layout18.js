...
export const Layout18 = ({
  ...
  return <Container>
    <div className="grid relative" style={{ paddingBottom: '70%' }}>
      <div className="absolute w-full h-full inset-0 gap-1 md:gap-6 grid grid-cols-4 grid-rows-4  content-between">
