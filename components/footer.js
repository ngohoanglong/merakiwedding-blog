...
export default function Footer() {
  const { get } = useSource()
  return (
    <footer className='space-y-6' style={{ fontSize: '15px', lineHeight: '1.857', padding: '40px 0', background: "#fdf6f0" }}>
      <div className="px-12 w-full flex justify-center space-x-6">
        ...
        <a target="_blank" href={get('app.data.socials.pinterest')} title="pinterest" className="text-5xl hover:shadow-lg rounded-full">
        ...
        <a target="_blank" href={get('app.data.socials.instagram')} title="instagram" className="text-5xl hover:shadow-lg rounded-full">
