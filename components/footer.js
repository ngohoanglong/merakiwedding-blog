  ...
  return (
    <footer style={{ fontSize: '15px', lineHeight: '1.857', padding: '40px 0', }}>
      <div className="p-12 w-full flex justify-center space-x-6">
        <a href={get('app.data.socials.facebook')} title="facebook" className="text-5xl hover:shadow-lg rounded-full">
        ...
        <a href={get('app.data.socials.pinterest')} title="pinterest" className="text-5xl hover:shadow-lg rounded-full">
        ...
        <a href={get('app.data.socials.instagram')} title="instagram" className="text-5xl hover:shadow-lg rounded-full">
