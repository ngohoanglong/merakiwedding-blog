...
const Editable = () => {
  const { isReady, isPreview, asPath } =
    useRouter()
    ...
    <>
      ...
      <div
        ...
        <div
          ...
          <div
            className={classNames(
              'transition-transform transform ease-in-out duration-700 origin-bottom',
              hasScrolled
            ...
            <img
              ...
              src="/home/icons/web-homepage-icons-06.png"
            />
          </div>
        </div>
      </div>
